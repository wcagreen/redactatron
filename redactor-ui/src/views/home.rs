...
impl HomePage {
    ...
    pub fn update(&mut self, ui: &mut egui::Ui, ctx: &egui::Context) -> Option<Vec<PathBuf>> {
        ...
        ui.vertical(|ui| {
            ui.label(
                egui::RichText::new("📄 File Redactor Application")
                    .size(18.0)
                    .strong(),
            );
            ...
            if !self.uploaded_files.is_empty() {
                ui.label(
                    egui::RichText::new("📤 Uploaded Files:")
                        .size(18.0)
                        .strong(),
                );
                ...
                ui.horizontal(|ui| {
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ...
                        // Submit (primary)
                        let submit_btn =
                            egui::Button::new(egui::RichText::new("Submit").size(16.0).strong())
                        ...
                        // Clear (secondary)
                        let clear_btn =
                            egui::Button::new(egui::RichText::new("Clear Files").size(14.0))
